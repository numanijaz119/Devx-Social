...
SECRET_KEY = 'django-insecure-))q6fw8xn@w@v^ndaqu^z*@qnqbcasj5j27o*w)oef4%*ae^iu'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'devx-7ffd46a1acc1.herokuapp.com']
...
# Simple Json Web Tokens Configuration
SIMPLE_JWT = {
